                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td><input type={ 'number' } name={ 'numberWords' } defaultValue={ 3 } style={ { borderColor: props.color } } onChange={ props.onChange } /></td>
                            </tr>
                            <tr>
                                <td><label>Separator:</label></td>
                                <td></td>
                                <td><input type={ 'text' } name={ 'separator' } style={ { borderColor: props.color } } onChange={ props.onChange } /></td>
                            </tr>
                            <tr>
